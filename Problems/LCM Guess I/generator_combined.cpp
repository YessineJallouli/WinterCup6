...
struct ReversePermutation : public PermutationDistribution
{
    int parameters_count() const
    {
        return 1;
    ...
    [[nodiscard]] std::shared_ptr<Cloneable> clone() const override
    {
        return std::make_unique<ReversePermutation>(*this);
    }

};

struct IdentityPermutation : public PermutationDistribution
{
    int parameters_count() const
    {
        return 1;
    ...
    [[nodiscard]] std::shared_ptr<Cloneable> clone() const override
    {
        return std::make_unique<IdentityPermutation>(*this);
    }
...
int main(int argc, char**argv)
{
    ...
    arrayManager.add<ReversePermutation>("reverse");
    arrayManager.add<IdentityPermutation>("identity");
    arrayManager.add<RandomPermutation>("random-permutation");
